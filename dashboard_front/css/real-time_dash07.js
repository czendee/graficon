...
var previousGroupNumber0701=0;//used to keep track of what group was displayed previously
var previousGroupNumber0702=0;//used to keep track of what group was displayed previously
var previousGroupNumber0703=0;//used to keep track of what group was displayed previously
var previousGroupNumber0704=0;//used to keep track of what group was displayed previously
...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0701+"&reference2=72&dato01=99&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   previousGroupNumber0701 =grupoNumberResultado;
                ...
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    ...
                    arrayResultados.forEach(myFunction0701) //set the values in the  graph points ,below
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0702+"&reference2=71&dato01=99&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0702 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0702) //set the values in the  graph points ,below
...
function myFunction0702(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0703+"&reference2=71&dato01=24&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0703 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0703) //set the values in the  graph points ,below
...
function myFunction0703(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0704+"&reference2=71&dato01=48&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0704 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0704) //set the values in the  graph points ,below
...
function myFunction0704(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
