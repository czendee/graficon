...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0201+"&reference2=22&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0202+"&reference2=21&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0203+"&reference2=21&dato01=24&dato02=88&dato03=77", function(data) {
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0204+"&reference2=21&dato01=48&dato02=88&dato03=77", function(data) {
            var linea=0;
