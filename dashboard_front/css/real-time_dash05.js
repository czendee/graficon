...
var previousGroupNumber0501=0;//used to keep track of what group was displayed previously
var previousGroupNumber0502=0;//used to keep track of what group was displayed previously
var previousGroupNumber0503=0;//used to keep track of what group was displayed previously
var previousGroupNumber0504=0;//used to keep track of what group was displayed previously
...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0501+"&reference2=51&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   previousGroupNumber0501 =grupoNumberResultado;
                ...
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    ...
                    arrayResultados.forEach(myFunction0501) //set the values in the  graph points ,below
...
function myFunction0501(item, index) {
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0502+"&reference2=51&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0502 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0502) //set the values in the  graph points ,below
...
function myFunction0502(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0503+"&reference2=51&dato01=24&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0503 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0503) //set the values in the  graph points ,below
...
function myFunction0503(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0504+"&reference2=51&dato01=48&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0504 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0504) //set the values in the  graph points ,below
...
function myFunction0504(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
