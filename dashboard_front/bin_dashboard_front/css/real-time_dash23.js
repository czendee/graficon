...
var previousGroupNumber0303=0;//used to keep track of what group was displayed previously
var previousGroupNumber0304=0;//used to keep track of what group was displayed previously
...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0301+"&reference2=32&dato01=99&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0302+"&reference2=31&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0303+"&reference2=31&dato01=24&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0303 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0303) //set the values in the  graph points ,below
...
function myFunction0303(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0304+"&reference2=31&dato01=48&dato02=88&dato03=77", function(data) {                  
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0304 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0304) //set the values in the  graph points ,below
...
function myFunction0304(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
