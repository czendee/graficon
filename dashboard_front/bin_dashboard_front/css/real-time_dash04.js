...
var previousGroupNumber0401=0;//used to keep track of what group was displayed previously
var previousGroupNumber0402=0;//used to keep track of what group was displayed previously
var previousGroupNumber0403=0;//used to keep track of what group was displayed previously
var previousGroupNumber0404=0;//used to keep track of what group was displayed previously
...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0401+"&reference2=42&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   previousGroupNumber0401 =grupoNumberResultado;
                ...
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    ...
                    arrayResultados.forEach(myFunction0401) //set the values in the  graph points ,below
...
function myFunction0401(item, index) {
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0402+"&reference2=41&dato01=99&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0402 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0402) //set the values in the  graph points ,below
...
function myFunction0402(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0403 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0403) //set the values in the  graph points ,below
...
function myFunction0403(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0404 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0404) //set the values in the  graph points ,below
...
function myFunction0404(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
//            setInterval(updateChart0201, valueRotacion);//every 20 seconds
    ...
    function go_next2() {
//        alert("next");
        window.location.href = "/v1/dash08";  
