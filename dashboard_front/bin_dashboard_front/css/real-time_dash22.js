...
var previousGroupNumber0201=0;//used to keep track of what group was displayed previously
var previousGroupNumber0202=0;//used to keep track of what group was displayed previously
var previousGroupNumber0203=0;//used to keep track of what group was displayed previously
var previousGroupNumber0204=0;//used to keep track of what group was displayed previously
...
//Medium
    ...
    function updateUsersMediumPieChartWithDB()
   {
        ...
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0201+"&reference2=222&dato01=00&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   previousGroupNumber0201 =grupoNumberResultado;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0202+"&reference2=222&dato01=00&dato02=88&dato03=77", function(data) {
            var linea=0;
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0203+"&reference2=222&dato01=01&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0203 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0203) //set the values in the  graph points ,below
...
function myFunction0203(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
...
///start
   ...
   {
             //use a parameter PageTitle {{.PageTitle}} set in net_v1.go with the server url
        $.getJSON("{{.PageTitle}}/v1/getDash02Grafica02?reference="+previousGroupNumber0204+"&reference2=222&dato01=02&dato02=88&dato03=77", function(data) {
            var linea=0;
...
//             var exito=2;// found and groupNubr is not greater than previousGroupNoumber0202, so use the current data in javascript
            ...
            $.each(data, function(key, value){
                ...
                if(linea ==2 && exito=="1"){//third  linea, viene nuevo group number
                   ...
                   var grupoNumberResultado= value;
                   previousGroupNumber0204 =grupoNumberResultado;

                }                
                if(linea ==3 && exito=="1"){//foruth linea, viene an array with the result data
                    var arrayResultados= value;//here the array of data structres passed
                    arrayResultados.forEach(myFunction0204) //set the values in the  graph points ,below
...
function myFunction0204(item, index) {
   //  demoP.innerHTML = demoP.innerHTML + "index[" + index + "]: " + item + "<br>"; 
